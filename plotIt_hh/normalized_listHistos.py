...
parser.add_argument('-d', '--directory', dest='directory', default="16_10_13_momInHistFactory_reretry", help='Directory of the input rootfiles.')
...
for key in keys:
    ...
    if key.GetName() not in alreadyIn and not "__" in key.GetName():
        ...
        #if "nonzero_ttweight" not in key.GetName(): continue
        ...
        # Yields
        if args.yields:
            if "isElEl_SF_hh_llmetjj_HWWleptons_btagM_csv_no_cut" in key.GetName():
                plot['x-axis'] = "isElEl"
